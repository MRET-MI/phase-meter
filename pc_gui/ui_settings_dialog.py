...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.trigSrcLabel = QLabel(self.settingsGroup)
        self.trigSrcLabel.setObjectName(u"trigSrcLabel")

        self.settingsLayout.addWidget(self.trigSrcLabel, 3, 0, 1, 1)

        self.trigSrcCombo = QComboBox(self.settingsGroup)
        self.trigSrcCombo.setObjectName(u"trigSrcCombo")

        self.settingsLayout.addWidget(self.trigSrcCombo, 3, 1, 1, 1)

        self.trigEdgeLabel = QLabel(self.settingsGroup)
        self.trigEdgeLabel.setObjectName(u"trigEdgeLabel")

        self.settingsLayout.addWidget(self.trigEdgeLabel, 3, 2, 1, 1)

        self.trigEdgeCombo = QComboBox(self.settingsGroup)
        self.trigEdgeCombo.setObjectName(u"trigEdgeCombo")

        self.settingsLayout.addWidget(self.trigEdgeCombo, 3, 3, 1, 1)

        self.trigNote = QLabel(self.settingsGroup)
        self.trigNote.setObjectName(u"trigNote")
        self.trigNote.setStyleSheet(u"color: #555;")

        self.settingsLayout.addWidget(self.trigNote, 3, 4, 1, 3)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.trigSrcLabel.setText(QCoreApplication.translate("SettingsDialog", u"trig_src", None))
        self.trigEdgeLabel.setText(QCoreApplication.translate("SettingsDialog", u"trig_edge", None))
        self.trigNote.setText(QCoreApplication.translate("SettingsDialog", u"External = RUN\u5f85\u6a5f, \u5916\u90e8\u30d1\u30eb\u30b9(PE7)=\u30b5\u30f3\u30d7\u30eb\u30af\u30ed\u30c3\u30af", None))
    # retranslateUi
