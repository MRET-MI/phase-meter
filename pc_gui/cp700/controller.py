...
from .transport import Cp700Transport
...
class StageStatus:
    ...
    @property
    def ready(self) -> bool:
        """全コマンド受付可（移動完了・停止状態）か。"""
        return self.state.upper() == "R"
...
class Cp700Controller:
    ...
    def is_ready(self) -> bool:
        """!: が R（全コマンド受付可＝移動完了）を返すか。"""
        return self.status_fast().strip().upper().startswith("R")
