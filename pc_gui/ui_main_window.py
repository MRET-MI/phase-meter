...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.waveformButton = QPushButton(MainWindow)
        self.waveformButton.setObjectName(u"waveformButton")

        self.ctrlLayout.addWidget(self.waveformButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.waveformButton.setText(QCoreApplication.translate("MainWindow", u"Waveform\u2026", None))
